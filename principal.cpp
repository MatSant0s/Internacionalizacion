...
void Principal::calcular()
{
    ...
    if(nombre.isEmpty()){
        ...
        QMessageBox::warning(this,tr("Salarios %1"),tr("No has proporcionado el nombre del obrero %1"));
        return;
    }
...
void Principal::on_actionGuardar_triggered()
{
    ...
    if(!f.open(QIODevice::WriteOnly | QIODevice::Append)){
        QMessageBox ::warning(this,tr("Salarios"), tr("No se ha abierto el archivo"));
        return;
    }
    ...
    ui->statusbar->showMessage(tr("Archivo guardado en ")+fileName,3000);
}
